...
public class FahrraederAnwendersystem {
    ...
    private Label lblVorhandeneGroeﬂen  		= new Label("Vorhandene Groeﬂen:");
    ...
    private TextField txtVorhandeneGroeﬂen	= new TextField();
    ...
    private void initKomponenten(){
    	...
    	lblVorhandeneGroeﬂen.setLayoutX(20);
    	lblVorhandeneGroeﬂen.setLayoutY(250);    	
       	pane.getChildren().addAll(lblEingabe, lblAnzeige, 
       		lblName, lblRahmennummer, lblFahrradtyp,
       		lblDHK, lblVorhandeneGroeﬂen);
    	...
    	txtVorhandeneGroeﬂen.setLayoutX(170);
    	txtVorhandeneGroeﬂen.setLayoutY(250);
    	txtVorhandeneGroeﬂen.setPrefWidth(200);
      	pane.getChildren().addAll( 
     		txtName, txtRahmennummer, txtFahrradtyp,
     		txtDHK, txtVorhandeneGroeﬂen);
    ...
    private void nehmeFahrradAuf(){
    	try{
    		this.fahrrad = new Fahrrad(
    		    ...
    		    txtDHK.getText(),
    		    txtVorhandeneGroeﬂen.getText().split(";"));
